...
<!-- Gioi thieu -->
<section data-aos="fade-up" data-aos-duration="1500" class="yl-bg px-5">
    <div class="text-center pb-5">
        <p class="title-dark">Giới thiệu WLIN MEDIA AGENCY</p>
    </div>

    <div class="row d-flex flex-row justify-content-between yl-bg mt-4 py-3 px-5">
        <div class="intro-content col-md-7 col-lg-7 col-xl-7 mt-4">
            <h4 class="py-3">WLIN LEADER ACADEMY</h4>
        ...
        <div class="col-md-4 col-lg-4 col-xl-4 mt-4">
            <img src="./Images/Asset 1 1.png" alt="" class="w-100" style="max-width: 442px; max-height: 633px;">
        </div>
    </div>

    <div class="row d-flex flex-row-reverse justify-content-between align-items-center yl-bg mt-4 py-3 px-5">
        <div class="intro-content col-md-7 col-lg-7 col-xl-7 mt-4">
            <h4 class="py-3">Lợi ích khi tham gia WLIN</h4>
            <p>There are many variations of passages of Lorem Ipsum available, but the majority have suffered
                alteration in some form, by injected humour, or randomised words which don't look even slightly
                believable. If you are going to use a passage of Lorem Ipsum, you need to be sure there isn't
                anything embarrassing hidden in the middle of text. All the Lorem Ipsum generators on the
    ...
    <!-- Du An-->
    <section data-aos="fade-up" data-aos-duration="1500" class="text-light p-3" style="max-height: 850px;">
        <div class="text-center pb-5">
            <p class="title-dark">Dự án</p>
        </div>

        <div class="project-slick-slider">
            <div class="slider-item">
                <div class="d-flex flex-column justify-content-center align-items-center ">
                    <div class="project-image">
                        <img src="./Images/media/duan.png" alt="..." />
                    </div>
                </div>
            </div>
            <div class="slider-item">
...
<!-- Xem them -->
<section class="text-center yl-bg p-5">
